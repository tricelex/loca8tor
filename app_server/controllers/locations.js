...
const homelist = (req, res) => {
  res.render('locations-list', {
    ...
    locations: [
      {
        name: 'Starcups',
        address: '34 Tarred Road, Ago, Okota',
        rating: 3,
        facilities: ['Hot drinks ', 'WiFi ', 'Pizza '],
        distance: '100m'
      },
      {
        name: 'Dominoes',
        address: '44 Okota Road',
        rating: 4,
        facilities: ['Hot drinks', 'WiFi', 'Pizza'],
        distance: '140m'
      },
...
const locationInfo = (req, res) => {
  res.render('location-info', {
    ...
    location: {
      ...
      rating: 3,
      facilities: ['Hot drinks', 'Food', 'Premium wifi', 'playStation'],
